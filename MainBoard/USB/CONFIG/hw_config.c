...
{
 	//cDebug("usb enter low power mode\r\n");
...
{ 
//	if (NewState!=DISABLE)cDebug("usb pull up enable\r\n"); 
//	else cDebug("usb pull up disable\r\n"); 
}
...
bool USART_Config(void)
{
	...
	cDebug("linecoding.format:%d\r\n",linecoding.format);
  	cDebug("linecoding.paritytype:%d\r\n",linecoding.paritytype);
	cDebug("linecoding.datatype:%d\r\n",linecoding.datatype);
	cDebug("linecoding.bitrate:%d\r\n",linecoding.bitrate);
	return (TRUE);
}
