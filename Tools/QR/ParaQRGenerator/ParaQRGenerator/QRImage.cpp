...
void QRImage::setString(QString str)
{
	string = str;
	if (qr != NULL)
	{
...
QSize QRImage::minimumSizeHint()  const
{
	QSize s;
	if (qr != NULL)
	{
...
bool QRImage::saveImage(QString fileName, int size)
{
...
void QRImage::draw(QPainter &painter, int width, int height)
{
...
void QRImage::paintEvent(QPaintEvent *)
{
